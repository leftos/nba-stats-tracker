...
[Files]
Source: "E:\Development\Visual Studio 2010\Projects\NBA Stats Tracker\NBA Stats Tracker\bin\Release\*"; DestDir: "{app}"; Flags: ignoreversion; Excludes: "*.vshost.*,*.xml,*.pdb"

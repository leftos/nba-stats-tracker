...
namespace LeftosCommonLibrary
{
    ...
    /// <summary>
    /// Used to scroll the FolderBrowserDialog to the selected path on open.
    /// Hack provided by Brad Oestreicher at
    ...
    public static class FolderBrowserLauncher
    {
        ...
        /// </summary>
        const string TopLevelSearchString = "Browse For Folder";
